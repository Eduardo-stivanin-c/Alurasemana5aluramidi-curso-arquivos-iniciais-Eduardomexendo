...
//#iniciao main principal  Javascript-web-paginas-dinamicas de Alura
...
function tecla9_click(){
	
	alert("tecla 9")
	
}

//exivbe tela de mesagem
//alert("teste de extensão chata ");
//escreve data e hora naoa tela da extensão ,verifica tudinh o se ta ´pronto como horario,verificando configurações motranod -las pqra ter certeza qyue estã ook pra logar
//document.write("altura da pagina" + innerHeight)
//document.write("largura da pagina" + innerWidth)
//document.getElementById("navegador").value=document.URL
//document.getElementById("link").href="https://web.whatsapp.com/"
ontem=new  Date();
//s ele retornará dia  da semana de ontem então  pra saber hoje  é somar um  ,e fus ohorario tbm precisa alterar o fuso
diasemana=ontem.getUTCDay()+1;

//retorna uma hora atual
var hora=ontem.getHours();
//correção em 31/10/2021 rHaloween de bug pra domingo
var diasemana_filtrado=diasemana;
/*
if(diasemana==1 ){
//1 é domingo
diasemana_filtrado="domingo";

}
if(diasemana==7 ){
//7 é sabado
diasemana_filtrado="sábado";

}
/*else(){
	// pra por o dia da smena util com o numero + ª pra 2ª , 3ª ,etc
	
}*/
/*
alert("dia da semana "+ diasemana_filtrado + "ª "+ "hora"+hora);
alert("disque 0 pra sábado;disque 1 pra domingo;disque 2 pra segunda;disque 3 pra terça;disque 4 pra quarta;disque 5 pra quinta;disque 6 pra sexta;")
*//*
var diadasemana=prompt("qual dia da semana hoje?",diasemana);
var tánahora=false;
...
//document.getElementById("PItecla").value=Math.PI
...
//document.getElementById("campo").value=Math.PI

//# se hora >19 horas eé vai dormir
//if(){
	
	
//}*/
///*
//PItecla.addEventListener("click",teclaconfig())

//configurando teclas , Keys  sã otecla no ingls , key é tecla
//var Key_PI=document.getElementById("PItecla")

//var Key_X=document.getElementById("X")
// a função recebe o paramentro
//
//configurnado teclas

//mostranavegador ,document.url liberla brej pra acesso ao códgio fonte
...
//window.open("chrome-extension://bifmfmnipjmikbkgfhkoeahcjkfghl6hm/index.html")
